...
![Architecture Diagram](https://placehold.co/800x400/eeeeee/999999?text=Architecture+Diagram)
...
├── deploy_backend_file_handling.sh # Helper: Deploys GCS buckets & Cloud Function
├── update_env.py         # Helper: Utility to write to the .env file
├── requirements.txt      # Python dependencies
├── cleanup_deployment.sh # Script to delete all deployed resources
│
├── a2a_demo_front/
│   ├── agents/chat_agent/  # Source for the Orchestrator Agent
│   └── front/              # Source for the Cloud Run Frontend
│
├── agents/remote_agents/ # Source for Specialized Agents
│   ├── gti_agent/        # GTI Agent (includes custom setup_alt.py)
